...
const fourthAbout = document.querySelector(".fourth-about");
const fourthName = document.querySelector(".fourth-name");
...
fourthProject.addEventListener("mouseover", () => {
  fourthProject.classList.add("project__onHover");
  fourthProject.classList.remove("fourth-project");
  fourthLink.classList.remove("none");
  fourthAbout.classList.remove("none");
  fourthName.classList.add("none");
});

fourthProject.addEventListener("mouseout", () => {
  fourthProject.classList.remove("project__onHover");
  fourthLink.classList.add("none");
  fourthProject.classList.add("fourth-project");
  fourthAbout.classList.add("none");
  fourthName.classList.remove("none");
});
